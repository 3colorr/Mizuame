...
final class MizuameTests: XCTestCase {
    ...
    //
    // test 1: Store testText.
    // expected 1: snapshot(of note: String) returns true.
    //
    // test 2: Add "efg" to testText then store testText.
    // expected 2: snapshot(of note: String) returns true.
    //
    // test 3: Run "Undo".
    // expected 3: undo() returns "abc".
    //
    // test 4: Run "Redo".
    ...
    //
    // test 6: Run "Undo" again.(A lower limit of redo/undo history test)
    // expected 7: undo() returns "abc".
    //
    // test 7: Store testText while add "x(=1...30)" to one then Run "Undo" 30 times.
    //         (A upper limit of redo/undo history test)
    // expected 8: 30th undo() returns "abc1".
    //
    func testRedoUndo() throws {
        ...
        XCTAssertFalse(manager.snapshot(of: testText))
